...
import domain.selector.PostSelector
import domain.selector.PostSelectorImpl
import domain.selector.UserSelector
import domain.selector.UserSelectorImpl
...
val selector = MainSelector(
    PostSelectorImpl(repository),
    UserSelectorImpl(repository),
)

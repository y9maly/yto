...
class FileServiceImpl(
    ...
    override suspend fun get(id: FileId): File? {
        return repo.file.get(id)
    }

    override suspend fun getClientStorageQuota(client: ClientId): ClientStorageQuota? {
    ...
    override suspend fun uploadParts(
        name: String?,
        owner: FileOwner,
    ...
    override suspend fun commitParts(
        uri: String,
        types: FileTypes?,
    ...
    override suspend fun download(id: FileId): Source? {
        return download(repo.file.get(id)?.uri ?: return null)
    }

    override suspend fun download(uri: String): Source? {
